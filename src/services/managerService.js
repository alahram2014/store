...
const OPERATIONAL_MODULES = [
  {
    ...
    requiredCapabilities: ['sales_manager.access', 'dashboard.sales_manager', 'sales_manager.manage_reps', 'dashboard.admin'],
  ...
  },
  {
    ...
    label: 'الطلبات',
    route: 'ops/orders',
    requiredCapabilities: ['orders.view', 'orders.review', 'orders.update', 'orders.manage', 'dashboard.admin'],
    description: 'إدارة الطلبات والانتقالات التنفيذية',
    runtimeReady: true,
  },
  {
    key: 'customers',
    label: 'العملاء',
    route: 'ops/customers',
    requiredCapabilities: ['customers.view', 'customers.manage', 'customers.create', 'sales_manager.assign_customers', 'dashboard.admin'],
  ...
  },
  {
    ...
    label: 'المنتجات',
    route: 'ops/products',
    requiredCapabilities: ['products.manage', 'catalog.manage', 'pricing.tiers.manage', 'stock.manage', 'dashboard.admin'],
  ...
  },
  {
    key: 'categories',
    label: 'التصنيفات',
    route: 'ops/categories',
    requiredCapabilities: ['catalog.manage', 'products.manage', 'dashboard.admin'],
    description: 'إدارة التصنيفات والظهور',
    runtimeReady: true,
  },
  {
    key: 'companies',
  ...
  },
  {
    ...
    label: 'المستخدمون',
    route: 'ops/users',
    requiredCapabilities: ['system.manage_users', 'system.manage_capabilities', 'dashboard.admin'],
    description: 'إدارة حسابات النظام والصلاحيات',
    runtimeReady: true,
  },
  {
    key: 'reps',
    label: 'المناديب',
    route: 'ops/reps',
    requiredCapabilities: ['sales_manager.manage_reps', 'sales_manager.access', 'dashboard.admin'],
    description: 'متابعة أداء المناديب وربط العملاء',
    runtimeReady: true,
  },
  {
    key: 'workflow',
    label: 'سير العمل',
    route: 'ops/workflow',
    requiredCapabilities: ['workflow.view', 'workflow.transition', 'workflow.manage', 'orders.review', 'dashboard.admin'],
...
async function loadManagerReps(api, ownerId, session = {}) {
  const rows = await api.get('system_users', isGlobalOperationalScope(session) ? {
