import { canAccessCustomerManagement, canAccessOperationalDashboard, hasCapability, hasOperationalAccess as hasCapabilityOperationalAccess, isSalesRepSession, normalizeCapabilityList } from './authService.js';
