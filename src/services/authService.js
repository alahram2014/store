...
export function normalizeSessionRecord(session) {
  ...
  const salesRepId = normalizeIdentifier(session.sales_rep_id || session.rep_id || session.created_by_rep_id || session.id || '');
  return {
    ...session,
...
const PROFILE_SELECT = {
  ...
  sales_reps: 'id,name,phone,username,location,default_tier_name,is_active,is_blocked,blocked_reason',
