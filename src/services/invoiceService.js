...
import { buildGoogleMapsUrl, isRepManagedCustomer, resolveSalesRepProjection } from './ownershipService.js';
...
المندوب: ${session?.system_user?.full_name || session?.sales_rep_name || repProjection.sales_rep_name || 'مندوب تابع'}
رقم المندوب: ${session?.system_user?.username || session?.sales_rep_phone || repProjection.sales_rep_phone || ''}
`
    : '';
