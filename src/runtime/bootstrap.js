...
import { login, logout, registerCustomer, normalizeUserType, normalizeSessionRecord, isSalesRepSession, getOwnershipActorId, hasCapability, persistSessionRecord, readPersistedSession, canAccessCustomerManagement, canAccessOperationalDashboard, refreshSessionProjection } from '../services/authService.js';
