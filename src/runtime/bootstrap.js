...
import { buildGoogleMapsUrl, projectInvoiceRuntimeRecord, projectCustomerOwnership, isRepManagedCustomer } from '../services/ownershipService.js';
...
import { renderDrawer, renderFloatingCart, renderToasts } from '../layout/overlays.js';
  ...
  document.addEventListener('submit', async (event) => {
    ...
    if (formType === 'customer-create') {
      ...
      const payload = {
        ...
        customer_type: 'rep',
        sales_rep_id: getOwnershipActorId(session) || session.id,
        created_by: session.id,
        created_by_rep_id: getOwnershipActorId(session) || session.id,
        is_active: true,
      };
